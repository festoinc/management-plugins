# Work-with-Jira Skill (Gemini CLI)
...
- **URL Validation**: If providing external links, use the `google_web_search` tool to ensure they are valid (not 404) and relevant.
